...
#' @importFrom nimble nimMatrix nimArray
#'
#' @param df data frame
#' @param occup logical
#' @param grow logical
...
#' @keywords internal
#' @noRd
int_datamodel <- function(df, occup, grow, modenv, modenvG, alt, timestep, period, var_id, var_tmp, var_tax, var_pres, var_reg, var_guild, var_cnt, var_wei, var_surf, var_pro, var_envO, var_envP, var_envC, var_grow) {
