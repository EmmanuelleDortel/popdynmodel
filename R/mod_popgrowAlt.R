#' Runs alternative multi-taxa growth models in a Bayesian hierarchical framework
#'
#' @import magrittr
#' @import nimble
...
#' mcmc.out <- mod_popgrowAlt(df[df$taxa == "pike",],var_id = "pop_id",var_tmp = "year",var_cnt = "headcount",var_pro = "fishing",n_chain=3,n_iter=10,n_thin=1,n_burnin=0)
#' mcmc.out <- mod_popgrowAlt(df,var_id = "pop_id",var_tmp = "year",var_tax = "taxa",var_wei = "biomass",var_pro = "fishing",n_chain=3,n_iter=10,n_thin=1,n_burnin=0)
#' mcmc.out <- mod_popgrowAlt(df,var_id = "pop_id",var_tmp = "year",var_tax = "taxa",var_cnt = "headcount",var_wei = "biomass",var_pro = "fishing",n_chain=3,n_iter=10,n_thin=1,n_burnin=0)
#' }
mod_popgrowAlt <- function(df, var_id, var_tmp, var_tax=NULL, var_cnt=NULL, var_wei=NULL, var_surf=NULL, var_pro = NULL, var_reg=NULL, var_guild=NULL, period=NULL, timestep=1, save_parameters = NULL, n_chain = 3, n_iter = 10000, n_thin = ceiling(n_iter/100), n_burnin = floor(n_iter/4)) {
  #-----------------------------------------------------------------------------
