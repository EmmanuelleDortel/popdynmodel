        ...
        for (s in 1:ntax) {
          for (j in 1:nreg[s]) {
            ...
            for (t in 2:ntime) {
              ...
              N_intlambda[s,reg[s,j],t] <- n_regt[s,reg[s,j],t] * sum(cal.N[s,reg[s,j],1:nidreg[s,j],t]) / max(1,sum(cal.N[s,reg[s,j],1:nidreg[s,j],t-1]))
        ...
        for (s in 1:ntax) {
          for (j in 1:nreg[s]) {
            ...
            for (t in 2:ntime) {
              ...
              B_intlambda[s,reg[s,j],t] <- b_regt[s,reg[s,j],t] * sum(cal.B[s,reg[s,j],1:nidreg[s,j],t]) / max(1,sum(cal.B[s,reg[s,j],1:nidreg[s,j],t-1]))
