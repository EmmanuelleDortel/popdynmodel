#' Runs multi-taxa environmental growth models in a Bayesian hierarchical framework
#'
#' @import magrittr
#' @import nimble
...
#' mcmc.out <- modenv_popgrow(df[df$taxa == "pike",],
#' var_id = "pop_id",
#' var_tmp = "year",
#' var_env = "temperature",
#' var_cnt = "headcount",
...
#' save_parameters = c("N_mulambda","B_mulambda"),
#' n_chain=3,n_iter=10,n_thin=1,n_burnin=0)
#' }
modenv_popgrow <- function(df, var_id, var_tmp, var_env, var_tax=NULL, var_cnt=NULL, var_wei=NULL, var_surf=NULL, var_reg=NULL, var_guild=NULL, period=NULL, timestep=1, save_parameters = NULL, n_chain = 3, n_iter = 102000, n_thin = 1000, n_burnin = 2000) {
  #-----------------------------------------------------------------------------
