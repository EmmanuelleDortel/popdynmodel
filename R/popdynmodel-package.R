...
globalVariables(c("ntax", "nreg", "nperiod", "reg", "start", "end", "step", "ntime", "nidreg","z","idreg","S","nid","idtax","y","C","ngvar","alpha_N","beta_N","gvar","ngui","nregui","regui","ngtax","gtax","W","w","alpha_B","beta_B","ndate","p.per","epsilon_per","p.col","epsilon_col","nvar","alpha_per","beta_per","var","alpha_col","beta_col","alpha"))
